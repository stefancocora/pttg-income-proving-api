...
See <<HTTP Conventions>>. Where possible, in the event of an error the API response body will contain further details
to help explain the error.
...
is missing, a response like this will be provided:
